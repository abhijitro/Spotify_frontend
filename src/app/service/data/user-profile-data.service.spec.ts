...
describe('UserProfileDataService', () => {
  ...
  it('should register a new user', () => {
    ...
    const phone = '7003559802';
    const dob = new Date();

    service.register(username,firstName,lastName, password, email,phone,dob).subscribe(userProfile => {
  ...
  it('should update user', () => {
    ...
    const mockUsername = 'testuser';
    const request = httpMock.expectOne(`${API_URL_USERPROFILE}/update/null`);
