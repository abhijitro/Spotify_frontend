...
describe('WishlistDataService', () => {
  ...
  it('should get user wishlist', () => {
    ...
    mockWishlist.username = 'testuser';
    mockWishlist.tracks = [
      mockTrack
    ];
    ...
    const params = new HttpParams().set('testuser', "username");
    const req = httpTestingController.expectOne(`${API_URL_WISHLIST}/getUserWishList?username=username`);
  ...
  it('should save track to wishlist', () => {
    ...
    const req = httpTestingController.expectOne(`${API_URL_WISHLIST}/saveTrackToWishlist?username=username`);
  ...
  it('should delete track by username and trackId', () => {
    ...
    const req = httpTestingController.expectOne(`${API_URL_WISHLIST}/removeTrack?username=username&trackId=mockTrackId`);
